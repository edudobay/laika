from .core import Config, Reporter, prepare_new_tree, run_build
...
def register(subparsers):
    parser = subparsers.add_parser('build', help='prepare a new deployment tree, without actually deploying it')
    parser.add_argument('ref', help='the Git ref (commit, branch, tag) that should be prepared')
    parser.add_argument(
